...
Also recompute the mid-versus-cross difference for each sampled trade at leg level and confirm its sign: under cross, bought legs cost more and sold legs receive less than under mid, so a long straddle's debit rises and an iron fly's credit falls.
