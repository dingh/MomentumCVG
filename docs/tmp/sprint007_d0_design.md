...
| **D2 fixed-position reference** | Paired `trade_log_*`, `leg_log_*` | `quantity`, leg `fill_price`, `pnl_per_unit`, `pnl_total_leg`, leg `portfolio_quantity` | **Feasible** — reprice under frozen quantity convention in D2 design |
