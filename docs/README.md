...
| [agenda/current_sprint.md](agenda/current_sprint.md) | Sprint 009 — `DRAFT — AWAITING REVIEW; IMPLEMENTATION NOT STARTED` | 2026-09-12 |
| [agenda/sprint9_short_body_wing_plan.md](agenda/sprint9_short_body_wing_plan.md) | Sprint 009 working plan — short-body economics, protection, and conditional filtering (draft) | 2026-09-12 |
